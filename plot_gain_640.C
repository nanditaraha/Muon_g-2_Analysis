{
  ...
  //Used the fact that the minimum is always at 30 us  to 32 us (checked every file - depends on tau_r which is same for all).

  TFile *f1 = TFile::Open("varyDrop_fac6_m100_c250_fil128_640_5.root");
  TFile *f2 = TFile::Open("varyDrop_fac8_m100_c250_fil128_640_5.root");
  TFile *f3 = TFile::Open("varyDrop_fac10_m100_c250_fil128_640_5.root");
  TFile *f4 = TFile::Open("varyDrop_fac12_m100_c250_fil128_640_5.root");
  TFile *f5 = TFile::Open("varyDrop_fac14_m100_c250_fil128_640_5.root");
  ...
  double err_x_100[5] = {x1_e,x2_e,x3_e,x4_e,x5_e};
  double err_y[5] = {0};
  
  //For 50 muons
  f1 = TFile::Open("varyDrop_fac6_m50_c250_fil128_640_5.root");
  f2 = TFile::Open("varyDrop_fac8_m50_c250_fil128_640_5.root");
  f3 = TFile::Open("varyDrop_fac10_m50_c250_fil128_640_5.root");
  f4 = TFile::Open("varyDrop_fac12_m50_c250_fil128_640_5.root");
  f5 = TFile::Open("varyDrop_fac14_m50_c250_fil128_640_5.root");
  ...
  //For 10 muons
  f1 = TFile::Open("varyDrop_fac6_m10_c250_fil128_640_5.root");
  f2 = TFile::Open("varyDrop_fac8_m10_c250_fil128_640_5.root");
  f3 = TFile::Open("varyDrop_fac10_m10_c250_fil128_640_5.root");
  f4 = TFile::Open("varyDrop_fac12_m10_c250_fil128_640_5.root");
  f5 = TFile::Open("varyDrop_fac14_m10_c250_fil128_640_5.root");
  ...
  TGraphErrors *gr1 = new TGraphErrors(5,drop_100,gain_min_100,err_x_100,err_y);
  gr1->SetMarkerColor(kBlue);
  gr1->SetMarkerStyle(21);
  mg->Add(gr1);

  TGraphErrors *gr2 = new TGraphErrors(5,drop_100,gain_min_50,err_x_50,err_y);
  gr2->SetMarkerColor(kRed);
  gr2->SetMarkerStyle(20);
  mg->Add(gr2);

  TGraphErrors *gr3 = new TGraphErrors(5,drop_100,gain_min_10,err_x_10,err_y);
