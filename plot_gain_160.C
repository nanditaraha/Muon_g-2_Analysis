{
  ...
  TFile *f1 = TFile::Open("noWiggle_fac6_g160_m100.root");
  TFile *f2 = TFile::Open("noWiggle_fac8_g160_m100.root");
  TFile *f3 = TFile::Open("noWiggle_fac10_g160_m100.root");
  TFile *f4 = TFile::Open("noWiggle_fac12_g160_m100.root");
  TFile *f5 = TFile::Open("noWiggle_fac14_g160_m100.root");
  //For 100 muons
  ...
  double x1_e = 0.02/sqrt(2000);// h1->GetBinError(30); -- error fixed by max detector resolution of 2%
  ...
  //For 50 muons
  f1 = TFile::Open("noWiggle_fac6_g160_m50.root");
  f2 = TFile::Open("noWiggle_fac8_g160_m50.root");
  f3 = TFile::Open("noWiggle_fac10_g160_m50.root");
  f4 = TFile::Open("noWiggle_fac12_g160_m50.root");
  f5 = TFile::Open("noWiggle_fac14_g160_m50.root");
  ...
  //For 10 muons
  f1 = TFile::Open("noWiggle_fac6_g160_m10.root");
  f2 = TFile::Open("noWiggle_fac8_g160_m10.root");
  f3 = TFile::Open("noWiggle_fac10_g160_m10.root");
  f4 = TFile::Open("noWiggle_fac12_g160_m10.root");
  f5 = TFile::Open("noWiggle_fac14_g160_m10.root");
  ...
  tex.DrawLatex(5.5,0.986,"JINST Value of G_{min} = 0.9887");
