{
  ...
  TFile *f1 = TFile::Open("varyDrop_fac6_m100_c1000_fil32_160_5.root");
  TFile *f2 = TFile::Open("varyDrop_fac8_m100_c1000_fil32_160_5.root");
  TFile *f3 = TFile::Open("varyDrop_fac10_m100_c1000_fil32_160_5.root");
  TFile *f4 = TFile::Open("varyDrop_fac12_m100_c1000_fil32_160_5.root");
  TFile *f5 = TFile::Open("varyDrop_fac14_m100_c1000_fil32_160_5.root");
  ...
  double x21 = h21->GetBinContent(31);
  ...
  double ey_2= sqrt(h2->GetBinError(30)*h2->GetBinError(30)+h21->GetBinError(31)*h21->GetBinError(31));
  ...
  //For 50 muons
  f1 = TFile::Open("varyDrop_fac6_m50_c1000_fil32_160_5.root");
  f2 = TFile::Open("varyDrop_fac8_m50_c1000_fil32_160_5.root");
  f3 = TFile::Open("varyDrop_fac10_m50_c1000_fil32_160_5.root");
  f4 = TFile::Open("varyDrop_fac12_m50_c1000_fil32_160_5.root");
  f5 = TFile::Open("varyDrop_fac14_m50_c1000_fil32_160_5.root");
  ...
  x31 = h31->GetBinContent(30);//Should spline - unfortunately 30 is empty
  ...
  //For 10 muons
  f1 = TFile::Open("varyDrop_fac6_m10_c1000_fil32_160_5.root");
  f2 = TFile::Open("varyDrop_fac8_m10_c1000_fil32_160_5.root");
  f3 = TFile::Open("varyDrop_fac10_m10_c1000_fil32_160_5.root");
  f4 = TFile::Open("varyDrop_fac12_m10_c1000_fil32_160_5.root");
  f5 = TFile::Open("varyDrop_fac14_m10_c1000_fil32_160_5.root");
  ...
  mg->SetTitle("Laser interval 160 #mus and step 5 #mus ;Drop per 100 MeV for a pulse in units of p_{0} = 4.26 #times 10^{-6};#DeltaG_{min}           ");
